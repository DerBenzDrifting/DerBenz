...
do
	...
	function section:addTextbox(title, default, callback)
		...
		input:GetPropertyChangedSignal("Text"):Connect(function()
			...
			if button.ImageTransparency == 0 and (button.Size == UDim2.new(0, 200, 0, 16) or button.Size == UDim2.new(0, 100, 0, 16)) then -- Ghost Menu
				utility:Pop(button, 10)
			end
	...
	function section:addColorPicker(title, default, callback)
		...
		for i, container in pairs(tab.Container.Inputs:GetChildren()) do -- Ghost Menu Channel
		...
		canvas.MouseButton1Down:Connect(function()
			...
			while draggingCanvas do
				...
				self:updateColorPicker(colorpicker, nil, {hue, sat, brightness}) -- Ghost Menu Channel
		...
		color.MouseButton1Down:Connect(function()
			...
			while draggingColor do
				...
				self:updateColorPicker(colorpicker, nil, {hue, sat, brightness}) -- Subscribe Ghost Menu
	...
	function section:updateColorPicker(colorpicker, title, color)
		...
		if type(color) == "table" then -- Ghost Menu Channel
